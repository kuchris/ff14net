...
internal static class AssemblyLoader
{
	...
	{
		assemblyNames.Add("ffxiv_act_plugin.common", "costura.ffxiv_act_plugin.common.dll.compressed");
		assemblyNames.Add("ffxiv_act_plugin.config", "costura.ffxiv_act_plugin.config.dll.compressed");
		assemblyNames.Add("ffxiv_act_plugin.logfile", "costura.ffxiv_act_plugin.logfile.dll.compressed");
		assemblyNames.Add("ffxiv_act_plugin.memory", "costura.ffxiv_act_plugin.memory.dll.compressed");
		assemblyNames.Add("ffxiv_act_plugin.network", "costura.ffxiv_act_plugin.network.dll.compressed");
		assemblyNames.Add("ffxiv_act_plugin.parse", "costura.ffxiv_act_plugin.parse.dll.compressed");
		assemblyNames.Add("ffxiv_act_plugin.resource", "costura.ffxiv_act_plugin.resource.dll.compressed");
